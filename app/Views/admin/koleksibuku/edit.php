...
<style>.kb-edit-wrapper{position:relative;background:url('<?= base_url('assets/img/backround3.jpg') ?>') center/cover no-repeat;min-height:100vh}.kb-overlay{position:absolute;inset:0;background:rgba(0,0,0,.6);backdrop-filter:blur(8px);z-index:1}.kb-container{position:relative;z-index:2;background:rgba(255,255,255,.88);padding:2rem;margin:2rem;border-radius:10px}</style>
